...
- [Murgia substrate roadmap](murgia-substrate-roadmap.md): source-backed matrix of NUX capabilities, gaps, and prioritized substrate slices for Murgia modern-hardware/AHCI/filesystem direction.
