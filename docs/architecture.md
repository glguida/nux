...
- APXH boot-path verification is still incomplete beyond the reviewed i386/multiboot and amd64 multiboot override paths: default-toolchain amd64, amd64 EFI, and riscv64 SBI/EFI need real target-toolchain/runtime verification, and the RISC-V EFI platform contract remains unresolved; see [hardware support](hardware-support.md) and [backlog](backlog.md).
